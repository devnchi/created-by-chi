...
function Post({ post }: Props) {
  ...
  return(
    <main>
        ...
        <article className='max-w-3xl mx-auto p-5'>
          ...
          <div>
            ...
            <p className='font-extralight text-sm'>
              Posted by{' '}
              <span className='text-purple-600'>{post.author.name}</span> - 
        ...
        {submitted ? (
          <div className='flex flex-col py-10 my-10 bg-purple-500 text-white max-w-2xl mx-auto'>
          <h3 className='text-3x font-bold'>Thank you for submitting your comment!</h3>
          <p>Once it has been approved, it will appear below.</p>
          </div>      
        ) : (
          <form 
          onSubmit={handleSubmit(onSubmit)} 
          className='flex flex-col p-5 max-w-7xl mx-auto mb-10'>

          <h3 className='text-sm text-purple-500'>Did you enjoy this article?</h3>
          ...
          <label className='block mb-5'>
            ...
            placeholder='Creative Humanbeing' 
            type='text' />
          </label>
          <label className='block mb-5'>
            ...
            className='shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-purple-500 outline-none focus:ring' 
            placeholder='creativehumanbeing@gmail.com' 
            type='email' />
          </label>
          <label className='block mb-5'>
          ...
          {/* a validation error will return if any of the required fields are not filled*/}
